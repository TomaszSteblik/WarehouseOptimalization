...
{
    internal class HGAXCrossover : Crossover
    {
        private double[][] DistancesMatrix { get; }
        public HGAXCrossover(ConflictResolver resolverConflict, ConflictResolver resolverRandomized, Random random, bool mutateIfSame) : base(resolverConflict, resolverRandomized, random, mutateIfSame)
        {
